...
def reconstruction_worker(adj, lt, distfn, objects):
...
def eval_reconstruction(adj, lt, distfn, workers=1):
    '''
    ...
    if workers > 1:
        ...
        results = reconstruction_worker(adj, lt, distfn, objects)
